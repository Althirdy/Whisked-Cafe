...
function ItemCard() {
  ...
  return (
    <>
      <div onClick={()=>setIsOpen(true)} className="p-4 border shadow-sm bg-white rounded-md relative cursor-pointer hover:bg-gray-50 z-1">
        {/* OrderCount */}
      ...
      <AddOnsModal isOpen={isOpen} onClose={() => setIsOpen(false)} />
    </>
  );
}
